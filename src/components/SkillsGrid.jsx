    ...
    const icons = {
      'React': (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.794 1.663-3.18 3.95-3.952 5.298-.139.248-.258.477-.348.673-.101.213-.15.38-.15.497 0 .179.085.396.233.597.14.194.33.35.545.453.21.1.43.148.628.148.258 0 .54-.075.824-.23 1.428-.78 3.458-2.158 5.302-3.824 1.845-1.667 3.496-3.54 4.253-4.948a.972.972 0 0 0 .132-.463c0-.25-.1-.47-.287-.628a1.12 1.12 0 0 0-.632-.22zm-9.77 10.69c0-1.41.73-2.674 1.87-3.41-.64-1.1-1.4-2.12-2.25-3.02C5.5 5.2 4.58 4.4 3.8 3.9c-.25-.16-.54-.24-.83-.24-.9 0-1.63.74-1.63 1.64 0 .36.12.7.34.97.9 1.1 2.16 2.6 3.51 4.36 1.35 1.76 2.58 3.62 3.46 5.03.2.32.45.58.73.78.3.2.63.3.97.3.9 0 1.63-.73 1.63-1.63zM3.6 18.304c.23.28.55.45.9.45.9 0 1.64-.73 1.64-1.63 0-.83-.6-1.48-1.22-2.04-.64-.57-1.34-1.15-1.97-1.64-.25-.2-.57-.32-.9-.32-.9 0-1.63.73-1.63 1.63 0 .36.13.7.35.97.64.78 1.52 1.78 2.5 2.95.98 1.16 2.05 2.4 2.94 3.47.2.25.45.42.73.5.3.1.62.1.93 0 .3-.08.58-.25.78-.48.9-1.07 1.96-2.31 2.94-3.47.98-1.17 1.86-2.17 2.5-2.95.22-.27.35-.61.35-.97 0-.9-.73-1.63-1.63-1.63-.33 0-.65.12-.9.32-.63.49-1.33 1.07-1.97 1.64-.62.56-1.22 1.21-1.22 2.04 0 .9.74 1.63 1.64 1.63.35 0 .67-.17.9-.45z"/>
        </svg>
      ),
      'JavaScript': (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
