 ...
 * Footer component
 * 
 * To edit social links, modify the socialLinks array below
 * To edit copyright text, change the year and name
 */
function Footer() {
  const currentYear = new Date().getFullYear()

  // Edit these to change your social media links
  const socialLinks = [
    {
      name: 'GitHub',
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/meronberihu0609',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:berihumeron06@gmail.com',
      icon: (
  ...
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 text-gray-300 dark:text-gray-400" role="contentinfo">
