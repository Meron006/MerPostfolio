    ...
    <div className="group bg-white rounded-2xl shadow-xl overflow-hidden card-hover border border-gray-100/50 relative">
      ...
      <div className="h-48 bg-gradient-to-br from-primary-100 via-primary-200 to-primary-300 flex items-center justify-center overflow-hidden relative">
        {project.image ? (
          ...
          <div className="text-primary-600 text-5xl font-bold group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.tech.map((tech, index) => (
            <span
              key={index}
              className="px-3 py-1.5 bg-gradient-to-r from-primary-50 to-primary-100 text-primary-700 text-xs font-semibold rounded-full border border-primary-200/50 group-hover:border-primary-300 group-hover:from-primary-100 group-hover:to-primary-200 transition-all duration-300 transform group-hover:scale-105"
        ...
        <div className="flex gap-4 pt-4 border-t border-gray-100">
          {project.github && (
            <a
              ...
              className="group/link flex items-center gap-2 text-primary-600 hover:text-primary-700 font-semibold transition-all duration-300 hover:gap-3"
            >
              <svg className="w-5 h-5 group-hover/link:rotate-12 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
